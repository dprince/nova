...
def upgrade(migrate_engine):
    ...
    # The only way to obtain a dns_domains table in this form is to create
    # a non-utf8 version first and then convert it to utf8. This is wrong...
    ...
    # NOTE(dprince): I think some of these can be removed
    indexes = [
